...
public class about_us extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<p>A Chain of Restaurant since 1995. Z Group restaurants are best know for their differentiated: Quality of the Food Family Dinning Oriented Ambiance.</p>");
            out.println("<p>The Z Group of Restaurants started in 1990. By godâ€™s grace and your continuous support, we have grown and reach to the heart of our customers...</p>");
            out.println("<p>Our Main Menu : </p>");
